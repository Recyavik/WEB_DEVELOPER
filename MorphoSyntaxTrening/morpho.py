...
SCORED_VAR_FEATURES: dict[str, list[str]] = {
    ...
    "Прилагательное":  ["форма", "число", "род", "падеж"],
    "Глагол":          ["наклонение", "время", "число", "лицо", "род"],
    "Причастие":       ["форма", "число", "род", "падеж"],
    "Деепричастие":    [],
    "Местоимение":     ["число", "род", "падеж"],
    "Числительное":    ["падеж"],
    "Наречие":         [],
    "Предлог":         [],
    "Союз":            [],
...
SCORED_CONST_FEATURES: dict[str, list[str]] = {
    ...
    "Причастие":       ["вид", "время", "залог"],
    "Деепричастие":    ["вид"],
    "Местоимение":     ["разряд", "лицо"],
    "Числительное":    ["разряд"],
    "Наречие":         [],
    "Предлог":         [],
    "Союз":            [],
...
# Pronoun разряд lookup by lemma (normal form)
_PRONOUN_RAZRYAD: dict[str, str] = {
    # личные
    "я": "личное", "ты": "личное", "он": "личное", "она": "личное",
    "оно": "личное", "мы": "личное", "вы": "личное", "они": "личное",
    # возвратное
    "себя": "возвратное",
    # притяжательные
    "мой": "притяжательное", "твой": "притяжательное", "свой": "притяжательное",
    "наш": "притяжательное", "ваш": "притяжательное",
    "его": "притяжательное", "её": "притяжательное", "их": "притяжательное",
    # вопросительные
    "кто": "вопросительное", "что": "вопросительное", "какой": "вопросительное",
    "который": "вопросительное", "чей": "вопросительное", "сколько": "вопросительное",
    # указательные
    "тот": "указательное", "этот": "указательное", "такой": "указательное",
    "столько": "указательное",
    # определительные
    "весь": "определительное", "всякий": "определительное", "каждый": "определительное",
    "сам": "определительное", "самый": "определительное", "иной": "определительное",
    "другой": "определительное", "любой": "определительное",
    # отрицательные
    "никто": "отрицательное", "ничто": "отрицательное",
    "никакой": "отрицательное", "ничей": "отрицательное",
    # неопределённые
    "некто": "неопределённое", "нечто": "неопределённое",
    "некоторый": "неопределённое", "несколько": "неопределённое",
    "кто-то": "неопределённое", "что-то": "неопределённое",
    "кто-нибудь": "неопределённое", "что-нибудь": "неопределённое",
    "кое-кто": "неопределённое", "кое-что": "неопределённое",
}
...
PARTICIPLE_TENSE_MAP = {"past": "прошедшее", "pres": "настоящее"}  # причастия не имеют будущего времени
...
def _const_features(pos_ru: str, p) -> dict:
    ...
    if pos_ru == "Существительное":
        ...
        if aspect:
            result["вид"] = aspect
        tense = _get_grammeme(g, PARTICIPLE_TENSE_MAP)
        if tense:
            result["время"] = tense
        ...
        if person:
            result["лицо"] = person
        razryad = _PRONOUN_RAZRYAD.get(p.normal_form.lower())
        if razryad:
            result["разряд"] = razryad
...
def _var_features(pos_ru: str, p) -> dict:
    ...
    if pos_ru in ("Существительное", "Прилагательное", "Причастие",
        ...
        if pos_ru != "Существительное":
            _add("род", GENDER_MAP)
        if pos_ru == "Прилагательное":
            result["форма"] = "краткая" if p.tag.POS in ("ADJS",) else "полная"
        elif pos_ru == "Причастие":
            result["форма"] = "краткая" if p.tag.POS == "PRTS" else "полная"
